  ...
  return (
    <section className="bg-[#0A0A0A]" ref={ref} aria-labelledby="about-title">
      ...
      >
        ...
        <Link href="#contact"
          className="inline-flex items-center gap-2 bg-accent text-[#0A0A0A] font-bold text-sm px-7 py-4 rounded-full hover:brightness-110 active:scale-[0.99] transition-all shrink-0 self-start md:self-auto">
          {t.about.cta}

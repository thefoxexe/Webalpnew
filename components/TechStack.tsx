...
export default function TechStack() {
  ...
  return (
    <section className="py-20 sm:py-24 bg-white" ref={ref} aria-labelledby="tech-title">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          {ts.options.map((opt, i) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-6 md:p-7 flex flex-col gap-5 cursor-default ${

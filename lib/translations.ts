...
export const translations = {
  fr: {
    ...
    problem: {
      ...
      facts: [
        { stat: '1 sur 2', text: 'PME suisse a un site qui n\'a généré zéro demande entrante le mois dernier. La plupart des propriétaires ne le savent pas.' },
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          features: ['Jusqu\'à 2 modifications/mois', 'Délai d\'exécution 48-72h', 'Sauvegardes quotidiennes', 'Monitoring & sécurité 24/7', 'Support par email', 'Rapport mensuel'],
        },
      ],
    },
    stats: {
    ...
    pricing: {
      label: 'Nos tarifs',
      h2: 'Le prix annoncé est le prix payé.',
    ...
    contact: {
      ...
      h2b: 'qui rapporte ?',
      body: 'Remplissez le formulaire et on vous répond sous 24h. On regarde votre situation et on revient avec un retour concret.',
      ...
      fields: {
        ...
        successBody: 'Merci pour votre message. On vous répond dans les 24h.',
  ...
  en: {
    ...
    problem: {
      ...
      facts: [
        { stat: '1 in 2', text: 'Swiss SMEs have a website that generated zero incoming inquiries last month. Most owners have no idea.' },
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          features: ['Up to 2 edits/month', '48-72h turnaround', 'Daily backups', '24/7 monitoring & security', 'Email support', 'Monthly report'],
        },
      ],
    },
    stats: {
    ...
    pricing: {
      label: 'Pricing',
      h2: 'The price we quote is the price you pay.',
    ...
    contact: {
      ...
      h2b: 'that pays off?',
      body: 'Fill in the form and we\'ll reply within 24h. We look at your situation and come back with concrete feedback.',
      ...
      fields: {
        ...
        successBody: 'Thank you for your message. We\'ll get back to you within 24h.',

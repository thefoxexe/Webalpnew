  ...
  fr: {
      ...
      items: [
        {
          ...
          features: ['Design 100% sur mesure', 'Mobile-first', 'SEO technique inclus', 'Formulaire de contact', 'Google Analytics', 'Formation incluse'],
        },
        {
          icon: 'search',
          number: '02',
    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Mise en ligne, analytics configurés, Google Business optimisé, formation incluse. On ne disparaît pas après la livraison — on suit vos performances.',
      ...
      plans: [
        {
          ...
          features: ['Site vitrine 5 pages', 'Design sur mesure', 'Mobile & tablette', 'SEO technique de base', 'Formulaire de contact', 'Google Analytics', '1 round de révisions', 'Formation incluse', 'Livraison en 14 jours'],
          popular: false,
        },
        {
          name: 'Croissance',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Est-ce que je peux changer mon site tout seul ?', a: 'Oui, et c\'est prévu. On vous livre un site sur un CMS accessible, avec une formation incluse. Modifier un texte ou une photo ? 2 minutes, pas besoin de nous appeler.' },
  ...
  en: {
      ...
      items: [
        {
          ...
          features: ['100% custom design', 'Mobile-first', 'SEO included', 'Contact form', 'Google Analytics', 'Training included'],
        },
        {
          icon: 'search',
          number: '02',
        ...
        },
        {
          ...
          features: ['CMS updates', 'Daily backups', 'SSL certificate', 'Support under 24h', 'Monthly report', '24/7 monitoring'],
        },
      ],
    },
    stats: {
    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          duration: 'Days 12-14',
          description: 'Go live, analytics configured, Google Business optimized, training included. We don\'t disappear after delivery — we track your performance.',
      ...
      plans: [
        {
          ...
          features: ['5-page showcase site', 'Custom design', 'Mobile & tablet', 'Basic SEO', 'Contact form', 'Google Analytics', '1 revision round', 'Training included', 'Delivered in 14 days'],
          popular: false,
        },
        {
          name: 'Growth',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Can I update my site myself?', a: 'Yes, and that\'s by design. We deliver a site on an accessible CMS with included training. Changing a text or photo? 2 minutes, no need to call us.' },
